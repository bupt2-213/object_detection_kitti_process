...
if __name__ == '__main__':
    ...
    train_files = []
    test_files = []
    _labeldir = os.path.join(_kittidir, 'training', 'label_2_car_new')
    files = glob.glob(os.path.join(_labeldir, '*.txt'))
    files.sort()
    train_file_dir = '../data/ImageSets_car_new/train.txt'
    test_files_dir = '../data/ImageSets_car_new/test.txt'
